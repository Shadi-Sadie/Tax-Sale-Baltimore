...
```{r}
## read data 
FBLN24 <- read.xlsx("2024 FBLNs 2-6-24.xlsx")
AR24 <- read.xlsx("2024 Tax Sale Auction Results - FINAL.xlsx")
...
```{r}
  ...
  FBLN23 <- read.xlsx("all FBLN properties 2023.xlsx")
  AR23 <- read.xlsx("2023 Tax Sale Results-with bidder information.xlsx")
...
FBLN22 <- read.xlsx("2022 TheRecord-20220519.xlsx")
AR22 <- read.xlsx("2022 Tax Sale Results.xlsx")
...
# read data 
  ...
  AR21 <- read.csv("2021_Tax_Sale_List_(With_Exempted_Properties).csv")
...
```{r}
  ...
  AR20 <- read.csv("bidbaltimore_certificate_sale_results_2020.csv")
